...
- 대상: board/login.php 웹 CTF 문제
- 허용 Target: 3.38.185.178
- CTF 승인: CONFIRMED — 학생 본인 확인 완료 (2026-08-14, 대상 IP 전체 포트/경로 허용으로 확정)

## Out of Scope

- 위 "허용 Target"(3.38.185.178) 이외의 어떤 호스트·포트에도 요청·스캔하지 않는다.
...
- 요청 대상이 3.38.185.178(및 그 하위 명시 경로/포트)가 아니면 즉시 중지한다.
